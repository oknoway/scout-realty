...
?>
<?php if ( get_sub_field( 'appearance' ) == 'recent-posts' ) :
  ...
  <article class="content-section <?php echo get_sub_field( 'appearance' ); ?>">
    ...
    <div class="small-container">
      ...
      <?php if ( get_sub_field( 'appearance' ) == 'neighborhood-finder' ) :
        
       get_template_part( 'partials/module', 'neighborhood-filter_home-price' );
